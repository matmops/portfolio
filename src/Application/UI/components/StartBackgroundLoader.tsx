      ...
      <div className="loader">
        ...
        <div className="container">
          ...
          <div className="paper-container red">
            <div className="paper-leaf-1 red-1" />
            <div className="paper-leaf-2 red-2" />
          </div>
          <div className="paper-container rotate-90">
            <div className="paper-leaf-1 yellow-1" />
            <div className="paper-leaf-2 yellow-2" />
          </div>
          <div className="paper-container rotate-180">
            <div className="paper-leaf-1 green-1" />
            <div className="paper-leaf-2 green-2" />
          </div>
          <div className="paper-container rotate-270">
            <div className="paper-leaf-1 blue-1" />
            <div className="paper-leaf-2 blue-2" />
          </div>
        </div>
        <div className="line" />
      </div>
